...
sendMessage($("#message").val()),$("#message").val(""),$("#message").focus(),!1;a=parseInt((new Date).getTime());a-threshold>lastTyping&&(sendTyping(),lastTyping=a)}),applyLogoutEvent(),applyWhoEvent(),applyClearMessagesEvent(),applyChangeStatusEvent(),$(".btn-tooltip").tooltip())))}function sendTyping(){conn.send(JSON.stringify({a:"typing"}))}function appendMessage(a){$(".messages").prepend('<div class="well well-sm message">'+a+"</div>")}usekey=!1;secret="";
