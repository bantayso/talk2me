...
function loginToRoom(a,b){console.log("reConnect: loginToRoom() running");try{conn.send(JSON.stringify({a:"login",room:a,username:b}))}catch(c){console.log("Could not reConnect to room: "+c)}}connected=!1;
