...
function sendMessage(a){if(!(void 0===a||1>a.length)){var a="<strong>@"+username+"</strong> "+a+' <span class="timestamp">'+getTimestamp()+"</span>",a=strip_tags(a,"<strong><em><table><thead><tbody><tr><th><td><img><br><br/><a><p><div><ul><li><ol><span><hr><hr/><dd><dl><dt>"),b='{"a": "message", "msg": "'+a.replace(/"/g,'\\"')+'"}';conn.send(b);appendMessage(a);$("html, body").animate({scrollTop:$(document).height()},1E3)}}
