...
function handleMessage(a){isLoggedIn&&(jsonObj=JSON.parse(a),"message"===jsonObj.a&&((new Audio("cdn/sounds/notification.ogg")).play(),appendMessage(jsonObj.msg)))}function appendMessage(a){$(".messages").append('<div class="well well-sm">'+a+"</div>");$("html, body").animate({scrollTop:$(document).height()},1E3)}
