...
function startConnection(a,b){connected?loginToRoom(a,b):(conn=new WebSocket(webSocketUrl),conn.onopen=function(){reConnecting&&clearMessages();connected=!0;reConnecting=!1;loginToRoom(a,b)},conn.onclose=function(){connected=isLoggedIn=!1;$("#message").remove();if(!reConnecting){$(".main-control").html('<div id="login-form"><\!--add form on reconnect--\></div>');var a=$("#connection-lost-msg").html(),a=Handlebars.compile(a),b={timestamp:getTimestamp()},a=a(b);appendMessage(a);reConnect()}},conn.onerror=
function(){connected=isLoggedIn=!1;$("#message").remove();if(!reConnecting){$(".main-control").html('<div id="login-form"><\!--add form on reconnect--\></div>');var a=$("#connection-lost-msg").html(),a=Handlebars.compile(a),b={timestamp:getTimestamp()},a=a(b);appendMessage(a);reConnect()}},conn.onmessage=function(a){isLoggedIn&&handleMessage(a.data)})}reConnecting=!1;
