...
function applyChangeStatusEvent(){$(".chg-status").on("click",function(){var a=$(this).text();$("#current-status").text(a);var b={a:"statusChange",status:a};console.log("Sending status change: "+a);conn.send(JSON.stringify(b));$("#message").focus();scrollToBottom()})}function applyWhoEvent(){$("#who").on("click",function(){who()})}function who(){conn.send(JSON.stringify({a:"who"}));$("#message").focus();scrollToBottom()}
